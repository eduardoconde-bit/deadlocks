...
// Função para simular Process B
void *processB(void *arg) {
    // Ambos os processos agora adquirem locks na mesma ordem para prevenir impasses
    pthread_mutex_lock(&lock1);  // Adquire lock1 antes de lock2 para prevenir deadlock
